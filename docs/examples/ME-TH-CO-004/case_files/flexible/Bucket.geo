/*
  Variables: L, D, ms_foundation, idpc,xc,yc,zc, idlid, idskirt, idbucket
*/

Function Bucket
  Geometry.AutoCoherence=0;
  // Position of the midpoint on edge (0<xm<D/2)
  xm=D/4.; 
  // Distribution coefficient for the inner point (it sets angles of 120º between inner lines to enhance the quality of the elements)

...
subroutine assemble_bem_bl_harela_equation(sb_int,se_int,se_int_n_snodes,sn_col,eq_index,gbl)
  ...
  integer              :: sn_col
  integer              :: eq_index
  complex(kind=real64) :: gbl(se_int_n_snodes,problem%n,problem%n)
      ...
      do il=1,problem%n
        ...
        do ik=1,problem%n
          do kn_int=1,se_int_n_snodes
            ...
            b_c(row,1)=b_c(row,1)+gbl(kn_int,il,ik)*node(sn_int)%cvalue_c(problem%n+ik,1,1)
          end do
        end do
      end do
        ...
        do ik=1,problem%n
          do kn_int=1,se_int_n_nodes
            ...
            do knt_int=1,se_int_n_snodes/se_int_n_nodes
              ...
              A_c(row,col)=A_c(row,col)-gbl(kncbl,il,ik)
            end do
          end do
        end do
      end do
      ...
      do il=1,problem%n
        ...
        do ik=1,problem%n
          do kn_int=1,se_int_n_snodes
            ...
            A_c(row,col)=A_c(row,col)-gbl(kn_int,il,ik)
          end do
        end do
      end do
...
end subroutine assemble_bem_bl_harela_equation

...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item \texttt{001} \href{ME-ST-SR-001/ME-ST-SR-001.pdf}{[TUTORIAL] Cantilever beam (FEM model)}.
                \item \texttt{002} \href{ME-ST-SR-002/ME-ST-SR-002.pdf}{[TUTORIAL] Rectangular Plate (FEM model)}.
                \item \texttt{003} \href{ME-ST-SR-003/ME-ST-SR-003.pdf}{[TUTORIAL] Scordelis-Lo Roof (FEM model)}.
                \item \texttt{004} \href{ME-ST-SR-004/ME-ST-SR-004.pdf}{[TUTORIAL] Spherical Shell (FEM model)}.
            \end{itemize}
            \item[\texttt{EL}] Elastostatics (continuum)
            \begin{itemize}
                \item \texttt{001} \href{ME-ST-EL-001/ME-ST-EL-001.pdf}{[TUTORIAL] Plain strain square (BEM model)}.
                \item \texttt{002} \href{ME-ST-EL-002/ME-ST-EL-002.pdf}{[TUTORIAL] Cube (BEM model)}.
            \end{itemize}            
            \item \texttt{CO} Coupled 
            \begin{itemize}
                \item \texttt{001} \href{ME-ST-CO-001/ME-ST-CO-001.pdf}{[TUTORIAL] Floating pile response under head force or moment (BEM-FEM model)}.
            \end{itemize}             
        \end{itemize}
        ...
        \begin{itemize}
            \item \texttt{SR} Structures
            \begin{itemize}
                \item \texttt{001} \href{ME-TH-SR-001/ME-TH-SR-001.pdf}{[TUTORIAL] Cantilever beam (FEM model)}.
            \end{itemize}             
            \item \texttt{EL} Elastodynamics (continuum)
            \begin{itemize}
                \item \texttt{001} \href{ME-TH-EL-001/ME-TH-EL-001.pdf}{[TUTORIAL] Cube (BEM model)}.
                \item \texttt{002} \href{ME-TH-EL-002/ME-TH-EL-002.pdf}{[TUTORIAL] Cantilever wall (BEM model)}.
                \item \texttt{003} \href{ME-TH-EL-003/ME-TH-EL-003.pdf}{[TUTORIAL] Soria arch dam: fixed-base (BEM model).}
            \end{itemize}            
            ...
            \begin{itemize}
                \item \texttt{001} \href{ME-TH-AC-001/ME-TH-AC-001.pdf}{[TUTORIAL] Pressure waves in a room (BEM model)}.
            \end{itemize}             
            \item \texttt{CO} Coupled 
            \begin{itemize}
                \item \texttt{001} \href{ME-TH-CO-001/ME-TH-CO-001.pdf}{[TUTORIAL] Impedances of inclined pile foundations (BEM-FEM model)}.
                \item \texttt{002} \href{ME-TH-CO-002/ME-TH-CO-002.pdf}{[TUTORIAL] Seismic response of a single inclined pile (BEM-FEM model)}.
                \item \texttt{003} \href{ME-TH-CO-003/ME-TH-CO-003.pdf}{[TUTORIAL] Impedances of a suction caisson / bucket foundation (BEM-FEM model)}.
                \item \texttt{004} \href{ME-TH-CO-004/ME-TH-CO-004.pdf}{[TUTORIAL] Seismic response of an Offshore Wind Turbine (BEM-FEM model)}.
                \item \texttt{005} \href{ME-TH-CO-005/ME-TH-CO-005.pdf}{[TUTORIAL] Soria arch dam: compliant base (BEM model)}.
                \item \texttt{006} \href{ME-TH-CO-006/ME-TH-CO-006.pdf}{[TUTORIAL] Soria arch dam: compliant base with 112 m water depth (BEM model)}.
            \end{itemize}                  
        \end{itemize}        
    \end{itemize}    
\end{itemize}

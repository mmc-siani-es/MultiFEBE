                          ...
                          case (fbem_potential)
                            ...
                            select case (node(sn)%ctype(1,1))
                              ...
                              case (2,3,4)
                                ...
                                node(sn)%value_c(1,1)=b_c(node(sn)%col(1,1),1)
                                node(sn)%value_c(2,1)=-c_im/rho/c/omega*node(sn)%cvalue_c(1,1,1)*node(sn)%value_c(1,1)
                            end select
                          ...
                          case (fbem_potential)
                            ...
                            select case (node(sn)%ctype(1,2))
                              ...
                              case (2,3,4)
                                ...
                                c=region(kr)%property_c(4)
                                node(sn)%value_c(1,2)=b_c(node(sn)%col(1,2),1)
                                node(sn)%value_c(2,2)=-c_im/rho/c/omega*node(sn)%cvalue_c(1,1,2)*node(sn)%value_c(1,2)
                            end select

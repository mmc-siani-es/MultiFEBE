...
\texttt{complex\_notation} & \texttt{polar} & \texttt{polar} & \multirow{2}{5cm}{Complex notation to be used when exporting: polar (absolute value and argument), or cartesian (real part and imaginary part).}  \\
  & \texttt{cartesian} & & 
\end{tabular}
